...
load(file = "modelos_pt_1.RData")
load(file = "modelos_pt_2.RData")
```
...
## ANALISE GERAL PARA OS TRABALHADORES PUBLICOS
...
## ANALISE PARA TRABALHADORES AFILIADOS
...
filiados_tipo %>%
  ...
  stargazer(title = "Summary Statistics for Political Affiliation in the Public Sector",
            ...
            covariate.labels = c("\\% Total", "\\% Career", "\\% Appointed", "\\% Other", "\\% Population Over 18"),
            header = F, digits = 2)
```
...
#" & One-Way & One-Way & Two-Ways & One-Way & One-Way & Two-Ways \\"

```

\begin{equation}
Dismissal_{i,t} = Career_{i,t-1} + Appointed_{i,t-1} + Duration_{i,t-1} + Political_{i,t}
\end{equation}

\begin{equation}
Hirings{i,t} = Career_{i,t} + Appointed_{i,t} + Political_{i,t}
\end{equation}

\begin{center}
\begin{longtable}{l c c c c c c}
\caption{Effects of Public Job Type and Affiliation on Dismissals and Hirings}
\label{reg}\\
\toprule
 & \multicolumn{3}{c}{Dismissals} & \multicolumn{3}{c}{Hirings} \\
...
\endlastfoot
Lag(Career)               & $0.159^{***}$  & $0.159^{***}$  & $0.158^{***}$  &                &                &                \\
                          & $(0.000)$      & $(0.000)$      & $(0.000)$      &                &                &                \\
Lag(Appointed)            & $0.006^{***}$  & $0.006^{***}$  & $0.006^{***}$  &                &                &                \\
                          & $(0.000)$      & $(0.000)$      & $(0.000)$      &                &                &                \\
Lag(Duration)             & $0.001^{***}$  & $0.001^{***}$  & $0.001^{***}$  &                &                &                \\
                          & $(0.000)$      & $(0.000)$      & $(0.000)$      &                &                &                \\
Power                     & $-0.013^{***}$ & $-0.013^{***}$ & $-0.005^{***}$ & $0.007^{***}$  & $0.007^{***}$  & $0.006^{***}$  \\
                          & $(0.001)$      & $(0.001)$      & $(0.001)$      & $(0.001)$      & $(0.001)$      & $(0.001)$      \\
Affiliation               &                & $0.001$        & $-0.008^{***}$ &                & $-0.006^{***}$ & $-0.003^{**}$  \\
                          &                & $(0.001)$      & $(0.001)$      &                & $(0.001)$      & $(0.001)$      \\
Power * GC &                &                & $0.001$        &                &                & $-0.001$       \\
                          &                &                & $(0.002)$      &                &                & $(0.002)$      \\
Career                    &                &                &                & $0.226^{***}$  & $0.226^{***}$  & $0.227^{***}$  \\
                          &                &                &                & $(0.000)$      & $(0.000)$      & $(0.000)$      \\
Appointed                 &                &                &                & $-0.036^{***}$ & $-0.036^{***}$ & $-0.036^{***}$ \\
                          &                &                &                & $(0.000)$      & $(0.000)$      & $(0.000)$      \\
\midrule
Individual FE             & Yes            & Yes            & Yes            & Yes            & Yes            & Yes            \\
Time FE                   & No             & No             & Yes            & No             & No             & Yes            \\
R$^2$                     & $0.115$        & $0.115$        & $0.115$        & $0.083$        & $0.083$        & $0.083$        \\
Adj. R$^2$                & $-0.033$       & $-0.033$       & $-0.032$       & $-0.048$       & $-0.048$       & $-0.048$       \\
Num. obs.                 & $6735092$      & $6735092$      & $6735092$      & $7697248$      & $7697248$      & $7697248$      \\
\end{longtable}
\end{center}
...
brasil <- read.csv("/Users/bernardoduque/Documents/Puc/Trabalho II/Trabalho Final/Input/brasil.csv") %>%
  ...
  mutate(pop = populacao*0.756) %>% #ajustando para populacao acima de 18 anos de acordo com PNS 2019
  select(ano, pop)
...
filiados_tipo %>%
  kable(caption = "Proportion of Affiliated Public Workers", booktabs = T,digits = 2,
      col.names = c("Year","Total","Career","Appointed", "Other", "Population Over 18"),
      row.names = F, format.args = list(big.mark = ","),
      align = "c") %>%
  kable_styling(latex_options = c("hold_position"), font_size = 12)# %>%
